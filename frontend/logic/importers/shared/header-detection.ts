 ...
 * Migrado de parseWithHeaderDetection() do HTML original.
 *
 * Exports de planilhas frequentemente têm linhas em branco ou de título
 * antes do cabeçalho real. Esta função varre as primeiras linhas procurando
 * a que contém todas as colunas obrigatórias e devolve os dados a partir
 * dali, com as chaves normalizadas (normHeader).
 */

import { normHeader } from "~/logic/lib/normalization";
